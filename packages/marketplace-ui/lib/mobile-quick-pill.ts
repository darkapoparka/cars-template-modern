...
export const getMobileQuickPillClassName = (
  ...
  cn(
    "inline-flex h-11 shrink-0 items-center gap-1.5 rounded-full border border-transparent border-y-2 bg-clip-padding px-3.5 font-medium text-[length:var(--text-compact-control)] text-zinc-950 leading-[var(--text-compact-control--line-height)] transition-colors focus-visible:outline-2 focus-visible:outline-[var(--lead-site-accent)] focus-visible:outline-offset-2",
    active
