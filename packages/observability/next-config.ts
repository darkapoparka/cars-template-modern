...
interface ConfigWithTranspilePackages {
...
export const withSentry = <Config extends ConfigWithTranspilePackages>(
  sourceConfig: Config
) => {
...
export const withLogging = (config: object): object =>
  isBetterStackLoggingConfigured() ? withLogtail(config) : config;
