...
const contactFields = [
  {
    ...
    autoComplete: "name",
    required: true,
    minLength: publicContactLimits.name.min,
    maxLength: publicContactLimits.name.max,
  },
  {
    name: "phone",
    type: "tel",
    autoComplete: "tel",
    required: true,
    minLength: publicContactLimits.phone.min,
    maxLength: publicContactLimits.phone.max,
  },
  {
    name: "email",
    type: "email",
